...
void List_Dispose( List *list ) {
	...
	while (list->firstElement != NULL) {
		ListElementPtr delete = list->firstElement;
...
void List_InsertFirst( List *list, int data ) {
	ListElementPtr item = malloc(sizeof(struct ListElement));
	if (item == NULL) {
		List_Error();
	}
	/* initialize new item */
...
void List_DeleteFirst( List *list ) {
	if (list->firstElement != NULL) {
		/* the removed element is the active element => list becomes inactive*/
...
void List_DeleteAfter( List *list ) {
	if (list->activeElement != NULL && list->activeElement->nextElement != NULL) {
		ListElementPtr delete = list->activeElement->nextElement;
